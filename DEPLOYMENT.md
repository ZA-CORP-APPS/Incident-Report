...
1. ✅ Installs system dependencies (Python 3.11+, virtualenv, OpenSSL)
2. ✅ Creates Python virtual environment
3. ✅ Installs all Python packages from requirements.txt
4. ✅ **Generates secure SESSION_SECRET automatically**
5. ✅ Creates systemd service with embedded SESSION_SECRET
6. ✅ Creates log directory with proper permissions
7. ✅ Enables auto-start on boot
8. ✅ Starts the application immediately
9. ✅ Displays admin credentials and access URL
...
1. Navigate to **Backup → Backup Settings**
...
- ✅ Proper logging to `/var/log/incident-log/`
